...
import com.appsdeveloper.app.ws.ui.model.request.UpdateUserDetailsRequestModel;
...
public class UserController {
	...
	public String getUsers(@RequestParam(value="page", defaultValue="1")int page,
			...
			@RequestParam(value="sort",defaultValue = "desending", required= false )String sort)
	{
	...
	public ResponseEntity<Void> deleterUser(@PathVariable String id)
	{
		users.remove(id);
